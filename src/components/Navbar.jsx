        ...
        <div className="nav-dropdown" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="nav-dropdown-menu">
              ...
              {categories.length === 0 ? (
                <div className="nav-dropdown-empty">No categories found</div>
              ) : (
                categories.map(cat => (
                  <button
                    key={cat.name}
                  ...
                  >
                    ...
                    <div className="nav-dropdown-text">
                      <span className="nav-dropdown-name">{cat.name}</span>
                      <span className="nav-dropdown-count">{cat.count} open positions</span>
                    </div>
